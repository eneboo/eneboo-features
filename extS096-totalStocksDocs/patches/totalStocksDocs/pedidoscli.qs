...
////////////////////////////////////////////////////////////////
//// TOTAL STOCKS DOCS /////////////////////////////////////////
class totalStocksDocs extends almacenEnSerie /** %from: oficial */
{
...
function totalStocksDocs_filtrarDatos()
{
  ...
  var referencia: String = this.child("tdbLineasPedidosCli").cursor().valueBuffer("referencia");

  var barcode: String = this.child("tdbLineasPedidosCli").cursor().valueBuffer("barcode");
  if (!barcode)
      barcode  = "";
