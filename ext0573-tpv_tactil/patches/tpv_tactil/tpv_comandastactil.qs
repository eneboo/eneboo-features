...
class oficial extends interna {
	...
	function borrarTodasLineas() {
		return this.ctx.oficial_borrarTodasLineas();
	}
...
function interna_init()
{
	...
	this.iface.tbnBorrarComanda = this.child("tbnBorrarComanda");
	...
	connect(this.iface.tbnBorrarComanda,"clicked()",this,"iface.borrarTodasLineas");
	...
	connect(this, "formReady()", this, "iface.mostrarPagina");
...
function oficial_borrarTodasLineas()
{
	var util:FLUtil;
	...
	if(!util.sqlDelete("tpv_lineascomanda","idtpv_comanda = " + idComanda))
		return false;
