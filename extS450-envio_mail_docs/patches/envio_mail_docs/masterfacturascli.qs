...
function envioMail_enviarDocumento(codFactura, codCliente)
{
  ...
  var cuerpo: String = util.readSettingEntry("scripts/flfactinfo/emailFVCuerpo");

  cuerpo = cuerpo.replace("<CodDocumento>",codFactura);
  ...
  var asunto: String = util.readSettingEntry("scripts/flfactinfo/emailFVAsunto");;

  asunto = asunto.replace("<CodDocumento>",codFactura);
  ...
  flfactppal.iface.pub_marcarEnviadoMail(idFactura,"idfactura","facturascli");
